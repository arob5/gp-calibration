...
in the \href{https://github.com/florianhartig/BayesianTools}{\texitt{BayesianTools}} R package. 
...
available radiation (PAR). Let $C_v$, $C_r$, and $C_s$ denote the quantity of carbon (kg $C/m^2$) in each of the three respective pools. 
