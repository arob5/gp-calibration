...
\newcommand{\SSROut}{\Phi^{(\outidx)}} % Sum of squared errors for specific output
...
\newcommand{\GPKer}{k} % Generic GP prior kernel/covariance function
\newcommand{\GPMeanOut}{\mu^{(\outidx)}} % Univariate GP prior mean function for specific output variable 
\newcommand{\GPKerOut}{k^{(\outidx)}} % Univariate GP prior covariance function for specific output variable
