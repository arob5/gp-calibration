...
We now investigate the uncertainty in the predictive equations \ref{kriging_eqns} when $\designOutLik$ is unknown and assumed to follow the current GP predictive distribution 
$\designOutLik \sim \Gaussian(\GPMeanPred[\Ndesign](\newInputMat), \GPKerPred[\Ndesign](\newInputMat))$. 
