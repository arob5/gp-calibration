...
%
% General land surface models (LSMs) 
%

\newcommand{\Npft}{N_{\textrm{pft}}}
...
\newcommand{\spaceIdx}{s}
\newcommand{\indexSpace}[2][\spaceIdx]{{#2}_{#1}}
\newcommand{\stateInitSpace}[1][\spaceIdx]{\state_{0,\spaceIdx}}
