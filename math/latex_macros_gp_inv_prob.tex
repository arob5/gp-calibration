...
% Log-likelihood, forward model, and posterior density emulators. 
\newcommand{\funcEm}[1][]{\func_{#1}}
\newcommand{\fwdEm}[1][]{\fwd_{#1}}
\newcommand{\llikEm}[1][]{\llik_{#1}} 
\newcommand{\llikEmFwd}[1][]{\llik^{\fwd}_{#1}}
\newcommand{\llikEmGeneric}[1][]{\tilde{\llik}_{#1}} 
\newcommand{\emMean}[2][]{\mu^{#2}_{#1}} % First argument is number of design points, second is the function being emulated. 
\newcommand{\emKer}[2][]{k^{#2}_{#1}}
