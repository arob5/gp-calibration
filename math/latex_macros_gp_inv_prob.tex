...
\newcommand{\llikEmGeneric}[1][\Ndesign]{\tilde{\llik}_{#1}}
...
\newcommand{\fwdEmQ}[2][\Ndesign]{{#2}_{#1}^{\quantileProb}}
\newcommand{\llikEmQDens}[1][\Ndesign]{\llikEmQ[#1]{\postDens}} 
\newcommand{\fwdEmQDens}[1][\Ndesign]{\fwdEmQ[#1]{\postDens}} 


\newcommand{\emPostDens}[1][]{\postDens_{#1}}
\newcommand{\emApprox}[2][]{{#2}_{#1}}
\newcommand{\emMeanApprox}[2][]{{#2}^{\text{mean}}_{#1}}
\newcommand{\emMargApprox}[2][]{{#2}^{\text{marg}}_{#1}}
\newcommand{\emPostDensMean}[1][]{\emMeanApprox[#1]{\postDens}}
\newcommand{\emPostDensMarg}[1][]{\emMargApprox[#1]{\postDens}}
