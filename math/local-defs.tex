...
\newcommand{\dataOut}{\mathbf{y}} % Generic output data. 
...
\newcommand{\designOutLik}{\boldsymbol{\ell}} % Vector of log-likelihood evaluations at design points. 
...
\newcommand{\newInputMat}{\mathbf{\tilde{U}}} % Typically use when considering arbitrary input points. 
\newcommand{\newInput}{\tilde{\bpar}}
\newcommand{\inputMat}[1][]{\mathbf{U}_{#1}} % Generic input matrix, with option of adding subscript. 
...
\newcommand{\batchMat}{\tilde{\mathbf{U}}} % Matrix of candidate points in batch acquisition.  TODO: duplicate to below, need to remove this. 
\newcommand{\inputMatBatch}{\mathbf{U}_{\Nbatch}} % Typically use when considering a batch of candidate input points
\newcommand{\outputVecBatch}{\boldsymbol{\ell}_{\Nbatch}}
