...
Small deviations from these assumptions commonly break the closed-form computations enjoyed in this limited setting.
...
using a new set of exact simulation evaluations. This presents a sequential design (i.e., active learning) problem, 
...
objective (i.e., acquisition) functions have been proposed that seek to to target high probability regions, 
...
facilitate improved interpretation of the resulting criteria in settings where closed-form expressions are available.
