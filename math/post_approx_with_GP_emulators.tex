...
Various discretized approximations might be considered, but face challenges beyond trivial low-dimensional 
examples. Owing to the difficulties of working with the sample-based approximation, common approaches in the 
...
propose a new class of GP-induced posterior approximations in \Cref{post_approx_mcmc}. \Cref{tbl:post-approx}
summarizes the various approximations considered. 
