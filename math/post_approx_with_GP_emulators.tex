...
rather than the underlying GPs themselves. This problem has gained recent attention, and is addressed in 
...
generically viewed as the analogs of existing GP acquisition functions to log-normal processes (LNPs). 
