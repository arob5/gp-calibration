...
constituting a modular surrogate-modeling approach \citep{modularization}. The mean and variance of the induced 
likelihood approximation can be described in closed-form for \todo

While the induced stochastic approximation 
