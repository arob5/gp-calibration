...
[also should add why UQ is important: scientific discovery and data-driven decision making] [make more clear that I'm working on statistical models, not the process models themselves]
...
methodological study has been conducted. Moreover, the existing methods treat emulator uncertainty in an independent fashion, failing to take advantage
of the correlation in Gaussian process predictions. I will address these gaps in the literature by (i.) conducting a rigorous comparison of methods
for propagating emulator uncertainty, (ii.) developing novel techniques which take advantage of the predictive correlation, and (iii.) [TODO]
