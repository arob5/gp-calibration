...
load(file.path(output_dir, "llik_em_llik.RData"))
load(file.path(output_dir, "llik_em_fwd.RData"))
load(file.path(output_dir, "test_info.RData"))

em_llik$plot_pred_validation(test_info$input, true_llik=test_info$llik, 
                             emulator_pred_list=test_info$pred_llik, plot_type="llik",
...
em_fwd$plot_pred_validation(test_info$input, true_llik=test_info$llik, 
                            emulator_pred_list=test_info$pred_fwd, plot_type="llik",
                            include_interval=TRUE, interval_method="pm_std_dev", N_std_dev=1, 
