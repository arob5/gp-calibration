...
```{r}
mcmc_settings_mcwmh_trunc_joint <- list(test_label="mcwmh_trunc_joint_acc_target", 
                                      mode="mcwmh",
                                      use_joint=TRUE,
                                      adjustment="truncated",
                                      mcmc_func_name="mcmc_noisy_llik", 
                                      n_itr=10000L, try_parallel=FALSE, 
...
```{r}
trace_plts_mcwmh_joint_trunc <- get_trace_plots(samp_dt, test_label="mcwmh_trunc_joint")
