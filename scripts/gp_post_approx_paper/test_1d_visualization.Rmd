...
# TODO: add quantiles as well and plot the llik truncated predictive 
# distribution. Then plot the expected likelihood (i.e., the marginal prediction)
# using Gunderson's formula for truncated log-normal. Need to make sure 
# I adapt the formula properly to the upper bound setting.
