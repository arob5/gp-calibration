...
#    - On pg. 30 of paper draft, potentially change mu_N(u|mu_n(U_B)) to mu_N(u).
...
u_grid <- sort(union(drop(u_grid), design_info$input))
N_grid <- length(u_grid)
test_info <- list(input=matrix(u_grid, ncol=1, dimnames=list(NULL, llik_exact$input_names)))
