...
acq_pw_gp_list <- compare_acq_funcs_by_model(test_info$input, acq_funcs_pointwise, gp_list)
acq_pw_post_list <- compare_acq_funcs_by_model(test_info$input, acq_funcs_pw_post, gp_list)
