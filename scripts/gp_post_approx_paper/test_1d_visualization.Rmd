...
em_llik$plot_llik_pred_1d(test_info$input, include_CI=TRUE, true_llik=test_info$llik, CI_prob=CI_prob)
...
test <- em_fwd$sample_emulator(test_info$input, N_samp=5, use_cov=TRUE)
```
