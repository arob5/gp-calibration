...
```{r}
# Integrated criteria. 
test <- evaluate_gp_acq_func_vectorized(acq_IEVAR_grid2, test_info$input, gp=em_fwd$emulator_model,
                                        grid_points=test_info$input)
tester <- cbind(a=acq_int_list$fwd[,"llik_IVAR_grid_gp"], b=test)
tester <- scale_acq(tester)
