...
plot(test_info$input, exp(test_info$llik), type="l", 
     main="True unnormalized likelihood", xlab="u", ylab="density")
...
emulator_pred_llik <- em_llik$emulator_model$predict(test_info$input, return_cov=TRUE)

em_llik$plot_pred_1d(test_info$input, include_CI=TRUE, true_llik=test_info$llik, 
                     CI_prob=CI_prob, plot_type="llik", emulator_pred_list=emulator_pred_llik)
...
emulator_pred_fwd <- em_fwd$emulator_model$predict(test_info$input, return_cov=TRUE)

em_fwd$emulator_model$plot_pred_1d(test_info$input, CI_prob=CI_prob, Y_new=matrix(test_info$fwd, ncol=1))[[1]]
em_fwd$plot_samp_1d(test_info$input, N_samp=5, plot_type="lik", true_llik=test_info$llik, include_design=TRUE)
