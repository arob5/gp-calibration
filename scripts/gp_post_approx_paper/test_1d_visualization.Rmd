...
u_true <- 3.0
sig2_true <- 1
y <- matrix(0) # fwd_model(rep(u_true, N_obs)) + sqrt(sig2_true) * rnorm(N_obs)
...
inv_prob <- list(llik_obj=llik_exact, par_prior=par_prior_params, y=y, par_true=u_true, sig2_true=sig2_true)
