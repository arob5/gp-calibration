...
plt_em_model_llik <- em_llik$emulator_model$plot_pred_1d(test_info$input, include_interval=TRUE, interval_method="CI",
                                                         CI_prob=CI_prob, pred_list=emulator_pred_llik, 
                                                         Y_new=matrix(test_info$llik, ncol=1), plot_title="GP predictions [llik]")[[1]]
plot(plt_em_model_llik)
...
em_llik$plot_pred_1d(test_info$input, include_interval=TRUE, true_llik=test_info$llik, 
                     CI_prob=CI_prob, plot_type="lik", emulator_pred_list=emulator_pred_llik, 
                     interval_method="pm_std_dev", plot_title="log-likelihood emulator distribution (llik emulation)")
...
em_fwd$emulator_model$plot_pred_1d(test_info$input, CI_prob=CI_prob, Y_new=matrix(test_info$fwd, ncol=1),
                                   pred_list=emulator_pred_fwd)[[1]]
...
lik_approx_llik_plt <- plot_curves_1d_helper(test_info$input, lik_approx_llik, y_new=exp(test_info$llik),
                                             ...
                                             plot_title="Likelihood Approximations: llik emulation",
...
lik_approx_fwd_plt <- plot_curves_1d_helper(test_info$input, lik_approx_fwd, y_new=exp(test_info$llik),
                                            X_design=design_info$input, y_design=exp(design_info$llik),
                                            plot_title="Likelihood Approximations: fwd emulation",
                                            xlab="u", ylab="Likelihood")
