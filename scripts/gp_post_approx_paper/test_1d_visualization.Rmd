...
pred_marg <- em_fwd$get_lik_approx(test_info$input, approx_type="marginal", emulator_pred_list=emulator_pred_fwd)
pred_mean <- em_fwd$get_lik_approx(test_info$input, approx_type="mean", emulator_pred_list=emulator_pred_fwd)
