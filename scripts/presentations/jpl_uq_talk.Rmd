...
plt_proj_talk <- llik_em_list[[em_name_talk]]$plot_1d_projection(proj_var, input_list_proj=input_list_proj,
                                                                 ...
                                                                 interval_method=interval_method, N_std_dev=N_std_dev)[[1]]
plt_proj_talk_mean_approx <- llik_em_list[[em_name_talk]]$plot_1d_projection(proj_var, input_list_proj=input_list_proj, 
                                                                             plot_type="lik_approx", 
                                                                             approx_types="mean",
                                                                             include_design=TRUE, plot_title=em_name_talk)[[1]]
...
plot(plt_proj_talk)
plot(plt_proj_talk_mean_approx)
plot(plt_proj_talk_marg_approx)
