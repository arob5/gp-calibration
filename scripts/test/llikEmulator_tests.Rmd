...
test <- llik_sum_emulator$llik_emulator_terms$output1$sample(test_info$inputs, lik_par=sig2_true[1], N_samp=10)
matplot(test_info$inputs, test, type="l", col="gray")
matlines(test_info$input, llik_true[,1], col="red")
