...
llik_sum_emulator$llik_emulator_terms$output2$plot_llik_samp_1d(test_info$inputs, lik_par_val=sig2_true[2], 
                                                                N_samp=50, use_cov=TRUE,
                                                                true_llik_new=llik_true[,2], 
                                                                include_design=TRUE)
