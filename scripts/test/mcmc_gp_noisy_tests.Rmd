...
# TODO: ensure the `par_curr` value in noisy MCMC GP has names attribute set. 
...
```{r}
#
# Run noisy MCMC function with exact llik for validation. 
#

samp_list <- mcmc_gp_noisy(llik_exact_obj, theta_prior_params, par_init=linear_Gaussian_info$true_posterior$mean[,1], 
                           sig2_init=NULL, sig2_prior_params=NULL, N_itr=N_mcmc,
                           adapt_cov_prop=FALSE, adapt_scale_prop=FALSE, use_gp_cov=TRUE,
                           cov_prop=linear_Gaussian_info$true_posterior$Cov)
