...
`run_mcmc()`. For more information on running exact MCMC, see the 
...
mcmc_exact_list <- run_mcmc("mcmc_bt_wrapper", llik_obj_exact, defer_ic=TRUE,
                            sampler="DEzs", n_chain=1L, par_prior=par_prior, 
                            n_itr=n_mcmc, test_label="exact")
...
mcmc_mean_approx_list <- run_mcmc("mcmc_bt_wrapper", llik_em, defer_ic=TRUE,
                                  approx_type="mean", sampler="DEzs", n_chain=1L, 
...
alpha <- 0.9
mcmc_quantile_approx_list <- run_mcmc("mcmc_bt_wrapper", llik_em, defer_ic=TRUE,
...
mcmc_mcwmh_list <- run_mcmc("mcmc_noisy_llik", llik_em, par_prior=par_prior,
                            n_chain=2L, n_itr=n_mcmc, test_label="mcwmh-joint",
                            try_parallel=FALSE, use_joint=TRUE, 
                            cov_prop=cov_prop_init, adapt_cov_prop=FALSE)
