...
derivatives.
```{r}
bt_list <- mcmc_bt_wrapper(llik_exact, par_prior, n_itr=n_mcmc, sampler="DEzs")
samp_dt <- format_mcmc_output(bt_list$samp, test_label="DEzs") 
```


## MCMC Diagnostics
```{r}
burn_in_start <- c(DEzs=10000L)
