...
\begin{align}
\acq[\designIdx](\batchMat) &= -\E_{\bpar \sim \rho} \Var\left[\logUnPostPred(\bpar) | \batchMat \right] \label{IVAR_GP}
\end{align}
...
\begin{align}
\acq[\designIdx](\batchMat) &= -\E_{\bpar \sim \rho} \E_{\tilde{\boldsymbol{\postDens}}  \sim \unPostPred} \Var\left[\unPostPred(\bpar) | \batchMat, \tilde{\boldsymbol{\postDens}}  \right]. \label{IVAR_LNP}
\end{align}
