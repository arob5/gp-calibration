...
Bayes_opt_settings <- list(acquisition_type = "EI_MC", opt_method = "grid", N_MC_samples = 1000)
...
emulator_info_list, design_input_curr, design_output_curr, design_best_idx,  
                               acquisition_type, opt_method, computer_model_data, sig2_eps, theta_prior_params, ...)

# Plots to consider doing: 
