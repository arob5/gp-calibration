...
new_design_sel <- seq(design_settings$N_design+1, nrow(lpost_emulator_temp$inputs_lpost$inputs))
...
lpost_numbered_plot <- get_2d_Bayes_opt_heatmap_plot(theta_vals = prior_grid_info$inputs, 
                                                     ...
                                                     sequential_design_points =lpost_emulator_temp$inputs_lpost$inputs[new_design_sel,,drop=FALSE],
                                                     raster = TRUE, 
