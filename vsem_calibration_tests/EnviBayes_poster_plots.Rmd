...
# TODO: increase size of design points 
...
plt_round0_samp <- plt_round0_samp + 
                   ...
                   # geom_density_2d(data = as.data.frame(samp_exact_theta), mapping = aes(x = LAR, y = KEXT), color = "blue") + 
...
ggsave(filename = file.path(base_dir, poster_figure_dir, "round0_mcmc_samp.svg"), width = 5.0, height = 5.0, units = "in")
...
lpost_numbered_plot_approx_scatter <- get_2d_Bayes_opt_heatmap_plot(theta_vals = samp_round0_info$inputs, 
                                                                    ...
                                                                    sequential_design_points=lpost_emulator_lpost_temp$inputs_lpost$inputs[new_design_sel,,drop=FALSE],
                                                                    raster = FALSE, 
                                                                    main_title = "Active Learning Design", 
