...
l_IVAR_uniform_wt <- acquisition_EIVAR_lpost(theta_vals = prior_grid_info$inputs_scaled, lpost_emulator = lpost_emulator, 
                                           theta_grid_integrate = prior_grid_info$inputs_scaled, 
                                           include_nugget = TRUE)

IVAR_uniform_wt <- acquisition_IVAR_post(theta_vals = prior_grid_info$inputs_scaled, lpost_emulator = lpost_emulator, 
                                        theta_grid_integrate = prior_grid_info$inputs_scaled, 
                                        include_nugget = TRUE)
