...
for(design_itr in seq_len(N_design_tests)) {
  ...
  # Produce IVAR-post and IVAR-lpost plots. 
  ...
  plt_list[[design_itr]] <- list()
  plt_list[[design_itr]]$IVAR_lpost <- get_2d_heatmap_plot(X = prior_grid_info$inputs[theta_grid_candidate_sel,], 
  ...
  plt_list[[design_itr]]$IVAR_post <- get_2d_heatmap_plot(X = prior_grid_info$inputs[theta_grid_candidate_sel,], 
