...
log_var_KB <- convert_to_post_emulator_log_moments(lpost_emulator_no_scale_cond, cond_lpost_pred$mean, cond_lpost_pred$var, return_vals = "log_var")$log_var
...
cond_log_var_MC_samp <- convert_to_post_emulator_log_moments(lpost_emulator_no_scale_cond_MC, cond_lpost_mean_samp, cond_lpost_var_samp)
