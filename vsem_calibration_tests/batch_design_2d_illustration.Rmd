...
```{r}
theta_grid_validate_sel <- sample(1:nrow(acquisition_settings$theta_grid_candidate), size = 100, replace = FALSE)
...
IVAR_post_MC_vals <- acquisition_IVAR_post_MC(theta_vals = samp_round0_info$inputs_scaled[theta_grid_validate_sel,,drop=FALSE], 
                                              ...
                                              computer_model_data = computer_model_data, verbose = FALSE, include_nugget = TRUE)
