...
# Note: this algorithm assumes that none of the theta are fixed; i.e. they are all calibration parameters. 

# TODO: where are NAs coming from here? 
...
print("theta Cov:")
print(stats::cov(theta_samp_Gibbs[burn_in:N_mcmc,]))

print("theta Mean:")
print(colMeans(theta_samp_Gibbs[burn_in:N_mcmc,]))

print("sig2_eps Var:")
print(mean(sig2_eps_samp_Gibbs[burn_in:N_mcmc,1]^2) - mean(sig2_eps_samp_Gibbs[burn_in:N_mcmc,1])^2)

print("sig2_eps Mean:")
print(mean(sig2_eps_samp_Gibbs[burn_in:N_mcmc,1]))
```
