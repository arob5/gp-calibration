...
We consider two latin hypercube designs (one with 20 design points and one with 30), as well as a design consisting of 30 points sampled from the true posterior for comparison. We consider 50 replications of each design so that the error metrics can be averaged over the replicates.  
```{r}
