...
```{r}
N_mcmc <- 100000
post_samples <- mcmc_calibrate(emulator_tests$computer_model_data$ref_pars, emulator_tests$computer_model_data$pars_cal_sel, emulator_tests$computer_model_data$data_obs, 
                               emulator_tests$computer_model_data$output_vars, emulator_tests$computer_model_data$PAR_data,
...
```{r, echo = FALSE}
# Evaluate predictive density at MCMC theta samples  
