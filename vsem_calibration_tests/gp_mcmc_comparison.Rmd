...
png(filename=file.path(poster_figure_dir, "lpost_GP_fit.png"))
...
ggsave(filename = file.path(poster_figure_dir, "approx_samples_pecan.png"), width = 5.0, height = 5.0, units = "in")
...
poster_figure_dir <- file.path(getwd(), "..", "..", "general-research", "images")
ggsave(filename = file.path(poster_figure_dir, "approx_samples_gibbs.png"), width = 5.0, height = 5.0, units = "in")
