...
lprior_u <- calc_lprior_theta(matrix(u_phi_grid$u, ncol=1), theta_prior_params)
...
lpost_marg_u <- calc_lprior_theta(prior_grid_info$inputs, theta_prior_params) - 0.5*(gp_pred_means^2 - a^2)/gp_pred_vars
...
gibbs_hist_plot <- get_hist_plot(list(samp_exact[1:nrow(samp_approx_hist_gibbs),,drop=FALSE], 
                                      ...
                                      main_title = "Histogram", data_names = c("exact", "gibbs")) + xlim(-3,3)
