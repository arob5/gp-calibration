...
mcmc_calibrate_ind_GP_Gibbs <- function(computer_model_data, theta_prior_params, emulator_info,
  ...
  return(list(theta=theta_samp, sig_eps=sig2_eps_samp, Cov_prop=Cov_prop, scale_prop=exp(log_scale_prop), SSR=SSR_samp, cov_prop_scales=cov_prop_scales))
...
mcmc_calibrate_ind_GP_joint <- function(computer_model_data, theta_prior_params, emulator_info,
                                        ...
                                        proposal_scale_decay=0.7, proposal_scale_multiplier=1, Cov_prop_init_diag = 0.1, adapt_cov_method = "AM", 
