...
print(ref_pars[pars_cal_sel, c("dist", "param1", "param2")])
```
...
where a = `r inv_gamma_a` and b = `r inv_gamma_b` which center the priors on the true values, with standard deviations `r sig_eps_prior_sd`. 
