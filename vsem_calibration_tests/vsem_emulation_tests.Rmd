...
N_test <- 10
X_train_test <- LHS_train_test(N_design_points, N_test, N_pars, theta_prior_params, joint = TRUE, extrapolate = FALSE)
...
# TODO: normalize design data y, X and think about cross validation strategy
```
